...
// --- VARIABLES DEL DINO ---
let anchoDino = 60; // Antes era 88 (más chico)
let altoDino = 65;  // Antes era 94 (más bajo)
let dinoX = 50;
...
let listaCactus = []; // Arreglo para guardar los cactus que van apareciendo
...
let altoCactus = 70;
let cactusX = 700; // Arrancan desde el lado derecho de la pantalla
let cactusY = altoTablero - altoCactus; // Posiciona al cactus en el piso
...
let velocidadY = 0;
let gravedad = 0.8;  // CAMBIADO: Antes era 0.4. Al ser más alta, lo tira para abajo más rápido.
...
window.onload = function() {
    tablero = document.getElementById("board"); // Agarra el canvas del HTML
...
function moverDino(e) {
    ...
    if ((e.code == "Space" || e.code == "ArrowUp") && dino.y == dinoY) {
        ...
        // Agacharse (Este bloque está vacío en el código original, acá iría la lógica)
    }
}
